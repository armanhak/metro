...
Отмечу, что для перечисленного функционала БД спроектирована эффективно. Это позволит с бд легко добавить/изменить/удалить новые Статусы заявок, Категории пассажиров, Метод примеа заявки и т.д.
