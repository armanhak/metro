    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.rank')),
                ('shift', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.smena')),
